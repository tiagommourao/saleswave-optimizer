...
const Reports: FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-sfa-dark mb-2">Relatórios</h1>
        <p className="text-sfa-secondary">Acesse relatórios detalhados para análise de vendas e desempenho</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-8">
        {reportsList.map((report) => (
          <Card key={report.id} className="shadow-sm hover:shadow-md transition-all cursor-pointer">
            ...
            <CardFooter className="flex justify-between pt-0">
              ...
              <Button variant="ghost" size="sm" className="text-sfa-primary">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Percentual de Vendas e Base para Prêmios</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="space-y-6">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold">85% alcançado</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div className="bg-sfa-primary h-2.5 rounded-full" style={{ width: '85%' }}></div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold">72% alcançado</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div className="bg-sfa-primary h-2.5 rounded-full" style={{ width: '72%' }}></div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold">65% alcançado</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div className="bg-sfa-primary h-2.5 rounded-full" style={{ width: '65%' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-3 gap-4">
            <div className="bg-gray-50 p-4 rounded-md text-center">
              <p className="text-sfa-secondary text-sm mb-1">Valor Vendido</p>
              <p className="text-xl font-bold">R$ 357.890</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-md text-center">
              <p className="text-sfa-secondary text-sm mb-1">Meta</p>
              <p className="text-xl font-bold">R$ 420.000</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-md text-center">
              <p className="text-sfa-secondary text-sm mb-1">Prêmio Estimado</p>
              <p className="text-xl font-bold">R$ 8.750</p>
            </div>
          </div>
        </CardContent>
      </Card>
